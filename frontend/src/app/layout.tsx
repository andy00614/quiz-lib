...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: '/icons/knowledge.png', sizes: '16x16', type: 'image/png' },
      { url: '/icons/knowledge.png', sizes: '32x32', type: 'image/png' },
      { url: '/icons/knowledge.png', sizes: 'any' },
    ],
    apple: [{ url: '/icons/knowledge.png', sizes: '180x180', type: 'image/png' }],
    other: [
      { url: '/icons/knowledge.png', sizes: '192x192', type: 'image/png' },
      { url: '/icons/knowledge.png', sizes: '512x512', type: 'image/png' },
    ],
  },
